/**
 * This is a modified version of this library: https://github.com/pshihn/bezier-points
 ...
 */
const flatness = (points: readonly Point[], offset: number): number => {
...
export const pointsOnBezierCurves = (
  points: readonly Point[],
...
const clone = (p: Point): Point => [...p] as Point;
